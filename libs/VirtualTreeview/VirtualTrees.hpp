...
// (DO NOT EDIT: machine generated header) 'Virtualtrees.pas' rev: 11.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EVirtualTreeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EVirtualTreeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
...
#pragma option push -b-
enum TVTColumnOption { coAllowClick, coDraggable, coEnabled, coParentBidiMode, coParentColor, coResizable, coShowDropMark, coVisible, coAutoSpring, coFixed, coSmartResize, coAllowFocus, coDisableAnimatedResize };
#pragma option pop

typedef Set<TVTColumnOption, coAllowClick, coDisableAnimatedResize>  TVTColumnOptions;

#pragma option push -b-
enum THitPosition { hiAbove, hiBelow, hiNowhere, hiOnItem, hiOnItemButton, hiOnItemCheckbox, hiOnItemIndent, hiOnItemLabel, hiOnItemLeft, hiOnItemRight, hiOnNormalIcon, hiOnStateIcon, hiToLeft, hiToRight };
#pragma option pop

typedef Set<THitPosition, hiAbove, hiToRight>  THitPositions;
...
#pragma option push -b-
enum TCheckImageKind { ckLightCheck, ckDarkCheck, ckLightTick, ckDarkTick, ckFlat, ckXP, ckCustom, ckSystem, ckSystemFlat };
#pragma option pop
...
#pragma option push -b-
enum TVTPaintOption { toHideFocusRect, toHideSelection, toHotTrack, toPopupMode, toShowBackground, toShowButtons, toShowDropmark, toShowHorzGridLines, toShowRoot, toShowTreeLines, toShowVertGridLines, toThemeAware, toUseBlendedImages, toGhostedIfUnfocused, toFullVertGridLines, toAlwaysHideSelection, toUseBlendedSelection, toStaticBackground };
#pragma option pop

typedef Set<TVTPaintOption, toHideFocusRect, toStaticBackground>  TVTPaintOptions;

#pragma option push -b-
enum TVTAnimationOption { toAnimatedToggle };
#pragma option pop

typedef Set<TVTAnimationOption, toAnimatedToggle, toAnimatedToggle>  TVTAnimationOptions;
...
#pragma option push -b-
enum TVTMiscOption { toAcceptOLEDrop, toCheckSupport, toEditable, toFullRepaintOnResize, toGridExtensions, toInitOnSave, toReportMode, toToggleOnDblClick, toWheelPanning, toReadOnly, toVariableNodeHeight, toFullRowDrag };
#pragma option pop

typedef Set<TVTMiscOption, toAcceptOLEDrop, toFullRowDrag>  TVTMiscOptions;
...
protected:
	...
	void __fastcall DoCanSplitterResize(const Types::TPoint &P, TColumnIndex Column, bool &Allow);
	void __fastcall DrawButtonText(HDC DC, WideString Caption, const Types::TRect &Bounds, bool Enabled, bool Hot, unsigned DrawFormat);
...
#pragma option push -b-
enum TVTHeaderOption { hoAutoResize, hoColumnResize, hoDblClickResize, hoDrag, hoHotTrack, hoOwnerDraw, hoRestrictDrag, hoShowHint, hoShowImages, hoShowSortGlyphs, hoVisible, hoAutoSpring, hoFullRepaintOnResize, hoDisableAnimatedResize };
#pragma option pop

typedef Set<TVTHeaderOption, hoAutoResize, hoDisableAnimatedResize>  TVTHeaderOptions;

#pragma option push -b-
enum THeaderState { hsAutoSizing, hsDragging, hsDragPending, hsLoading, hsTracking, hsTrackPending };
#pragma option pop

typedef Set<THeaderState, hsAutoSizing, hsTrackPending>  THeaderStates;
...
__published:
	...
	__property unsigned Height = {read=FHeight, write=SetHeight, default=17};
...
#pragma option push -b-
enum VirtualTrees__61 { tsCancelHintAnimation, tsChangePending, tsCheckPropagation, tsCollapsing, tsToggleFocusedSelection, tsClearPending, tsClipboardFlushing, tsCopyPending, tsCutPending, tsDrawSelPending, tsDrawSelecting, tsEditing, tsEditPending, tsExpanding, tsHint, tsInAnimation, tsIncrementalSearching, tsIncrementalSearchPending, tsIterating, tsKeyCheckPending, tsLeftButtonDown, tsLeftDblClick, tsMouseCheckPending, tsMiddleButtonDown, tsMiddleDblClick, tsNeedScale, tsNeedRootCountUpdate, tsOLEDragging, tsOLEDragPending, tsPainting, tsRightButtonDown, tsRightDblClick, tsPopupMenuShown, tsScrolling, tsScrollPending, tsSizing, tsStopValidation, tsStructureChangePending, tsSynchMode, tsThumbTracking, tsUpdateHiddenChildrenNeeded, tsUpdating, tsUseCache, tsUserDragObject, tsUseThemes, tsValidating, tsValidationNeeded, tsVCLDragging, tsVCLDragPending, tsWheelPanning, tsWheelScrolling, tsWindowCreating };
#pragma option pop
...
typedef void __fastcall (__closure *TVTAfterGetMaxColumnWidthEvent)(TVTHeader* Sender, TColumnIndex Column);
...
typedef void __fastcall (__closure *TVTCanSplitterResizeColumnEvent)(TVTHeader* Sender, const Types::TPoint &P, TColumnIndex Column, bool &Allow);
...
private:
	...
	int __fastcall CompareNodePositions(PVirtualNode Node1, PVirtualNode Node2);
	...
	int __fastcall InitializeLineImageAndSelectLevel(PVirtualNode Node, TLineImage &LineImage);
	...
	void __fastcall PrepareCell(TVTPaintInfo &PaintInfo, int WindowOrgX, int MaxWidth);
...
protected:
	...
	virtual void __fastcall DoHeaderClick(TColumnIndex Column, Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	virtual void __fastcall DoHeaderDblClick(TColumnIndex Column, Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	...
	virtual void __fastcall DoStateChange(const TVirtualTreeStates &Enter, const TVirtualTreeStates &Leave = Set<VirtualTrees__61, tsCancelHintAnimation, tsWindowCreating> () );
	...
	virtual int __fastcall GetCheckImage(PVirtualNode Node);
	...
	virtual void __fastcall HandleMouseDown(Messages::TWMMouse &Message, const THitInfo &HitInfo);
	...
	virtual void __fastcall PaintNodeButton(Graphics::TCanvas* Canvas, PVirtualNode Node, const Types::TRect &R, int ButtonX, int ButtonY, Classes::TBiDiMode BidiMode);
	...
	__property TCheckImageKind CheckImageKind = {read=FCheckImageKind, write=SetCheckImageKind, default=0};
...
public:
	...
	PVirtualNode __fastcall AddChild(PVirtualNode Parent, void * UserData = (void *)(0x0));
	...
	PVirtualNode __fastcall GetFirst(void);
	PVirtualNode __fastcall GetFirstChecked(TCheckState State = (TCheckState)(0x2));
	PVirtualNode __fastcall GetFirstChild(PVirtualNode Node);
	PVirtualNode __fastcall GetFirstCutCopy(void);
	PVirtualNode __fastcall GetFirstInitialized(void);
	PVirtualNode __fastcall GetFirstLeaf(void);
	PVirtualNode __fastcall GetFirstLevel(unsigned NodeLevel);
	PVirtualNode __fastcall GetFirstNoInit(void);
	PVirtualNode __fastcall GetFirstSelected(void);
	PVirtualNode __fastcall GetFirstVisible(void);
	...
	PVirtualNode __fastcall GetFirstVisibleNoInit(void);
	virtual void __fastcall GetHitTestInfoAt(int X, int Y, bool Relative, THitInfo &HitInfo);
	PVirtualNode __fastcall GetLast(PVirtualNode Node = (void *)(0x0));
	PVirtualNode __fastcall GetLastInitialized(PVirtualNode Node = (void *)(0x0));
	PVirtualNode __fastcall GetLastNoInit(PVirtualNode Node = (void *)(0x0));
	PVirtualNode __fastcall GetLastChild(PVirtualNode Node);
	PVirtualNode __fastcall GetLastChildNoInit(PVirtualNode Node);
	PVirtualNode __fastcall GetLastVisible(PVirtualNode Node = (void *)(0x0));
	...
	PVirtualNode __fastcall GetLastVisibleNoInit(PVirtualNode Node = (void *)(0x0));
	...
	PVirtualNode __fastcall GetNextChecked(PVirtualNode Node, TCheckState State = (TCheckState)(0x2));
	PVirtualNode __fastcall GetNextCutCopy(PVirtualNode Node);
	PVirtualNode __fastcall GetNextInitialized(PVirtualNode Node);
	...
	PVirtualNode __fastcall GetNextNoInit(PVirtualNode Node);
	PVirtualNode __fastcall GetNextSelected(PVirtualNode Node);
	PVirtualNode __fastcall GetNextSibling(PVirtualNode Node);
	PVirtualNode __fastcall GetNextVisible(PVirtualNode Node);
	PVirtualNode __fastcall GetNextVisibleNoInit(PVirtualNode Node);
	...
	PVirtualNode __fastcall GetPrevious(PVirtualNode Node);
	PVirtualNode __fastcall GetPreviousChecked(PVirtualNode Node, TCheckState State = (TCheckState)(0x2));
	PVirtualNode __fastcall GetPreviousCutCopy(PVirtualNode Node);
	PVirtualNode __fastcall GetPreviousInitialized(PVirtualNode Node);
	...
	PVirtualNode __fastcall GetPreviousNoInit(PVirtualNode Node);
	PVirtualNode __fastcall GetPreviousSelected(PVirtualNode Node);
	PVirtualNode __fastcall GetPreviousSibling(PVirtualNode Node);
	PVirtualNode __fastcall GetPreviousVisible(PVirtualNode Node);
	PVirtualNode __fastcall GetPreviousVisibleNoInit(PVirtualNode Node);
	...
	PVirtualNode __fastcall IterateSubtree(PVirtualNode Node, TVTGetNodeProc Callback, void * Data, TVirtualNodeStates Filter = Set<TVirtualNodeState, vsInitialized, vsToggling> () , bool DoInit = false, bool ChildNodesOnly = false);
	...
	void __fastcall SortTree(TColumnIndex Column, TSortDirection Direction, bool DoInit = true);
...
protected:
	...
	__property TVTMiscOptions MiscOptions = {read=FMiscOptions, write=SetMiscOptions, default=425};
...
__published:
	...
	__property MiscOptions  = {default=425};
...
protected:
	virtual void __fastcall ComputeHeaderLayout(HDC DC, const Types::TRect &Client, bool UseHeaderGlyph, bool UseSortGlyph, Types::TPoint &HeaderGlyphPos, Types::TPoint &SortGlyphPos, Types::TRect &TextBounds);
	virtual void __fastcall DefineProperties(Classes::TFiler* Filer);
...
__published:
	__property Classes::TAlignment Alignment = {read=FAlignment, write=SetAlignment, default=0};
	__property Classes::TBiDiMode BiDiMode = {read=FBiDiMode, write=SetBiDiMode, stored=IsBiDiModeStored, default=0};
	__property Graphics::TColor Color = {read=FColor, write=SetColor, stored=IsColorStored, default=-16777211};
...
typedef PVirtualNode __fastcall (__closure *TGetNextNodeProc)(PVirtualNode Node);
...
public:
	...
	AnsiString __fastcall ContentToText(TVSTTextSourceType Source, char Separator);
	WideString __fastcall ContentToUnicode(TVSTTextSourceType Source, WideChar Separator);
	virtual void __fastcall GetTextInfo(PVirtualNode Node, TColumnIndex Column, const Graphics::TFont* AFont, Types::TRect &R, WideString &Text);
	virtual Types::TRect __fastcall InvalidateNode(PVirtualNode Node);
	WideString __fastcall Path(PVirtualNode Node, TColumnIndex Column, TVSTTextType TextType, WideChar Delimiter);
	virtual void __fastcall ReinitNode(PVirtualNode Node, bool Recursive);
...
public:
	__fastcall TStringEditLink(void);
...
__published:
	...
	__property CheckImageKind  = {default=0};
...
//-- var, const, procedure ---------------------------------------------------
#define VTVersion "4.7.0"
static const Shortint VTTreeStreamVersion = 0x2;
static const Shortint VTHeaderStreamVersion = 0x4;
...
#define DefaultPaintOptions (Set<TVTPaintOption, toHideFocusRect, toStaticBackground> () << TVTPaintOption(5) << TVTPaintOption(6) << TVTPaintOption(8) << TVTPaintOption(9) << TVTPaintOption(11) << TVTPaintOption(12) )
#define DefaultAnimationOptions EMPTYSET
#define DefaultAutoOptions (Set<TVTAutoOption, toAutoDropExpand, toAutoBidiColumnOrdering> () << TVTAutoOption(0) << TVTAutoOption(3) << TVTAutoOption(6) << TVTAutoOption(8) )
#define DefaultSelectionOptions EMPTYSET
#define DefaultMiscOptions (Set<TVTMiscOption, toAcceptOLEDrop, toFullRowDrag> () << TVTMiscOption(0) << TVTMiscOption(3) << TVTMiscOption(5) << TVTMiscOption(7) << TVTMiscOption(8) )
#define DefaultColumnOptions (Set<TVTColumnOption, coAllowClick, coDisableAnimatedResize> () << TVTColumnOption(0) << TVTColumnOption(1) << TVTColumnOption(2) << TVTColumnOption(3) << TVTColumnOption(4) << TVTColumnOption(5) << TVTColumnOption(6) << TVTColumnOption(7) << TVTColumnOption(11) )
#define DefaultStringOptions (Set<TVTStringOption, toSaveCaptions, toAutoAcceptEditChange> () << TVTStringOption(0) << TVTStringOption(2) )
...
extern PACKAGE void __fastcall DrawTextW(HDC DC, WideChar * lpString, int nCount, Types::TRect &lpRect, unsigned uFormat, bool AdjustRight);
